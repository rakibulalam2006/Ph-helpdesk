...
const Card = ({ issue,data,setData }) => {
  ...
  const handleClick = () =>{
    ...
    const restedData = data.filter((elem) => elem.ticketId !=issue.ticketId);

    console.log({currentData,restedData})
    setData([currentData,...restedData])
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between">
        <h2 className="text-xl font-bold">{issue.subject}</h2>
        <div>
          <span
